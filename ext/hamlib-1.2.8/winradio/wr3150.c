...
#define WR3150_FUNC  RIG_FUNC_NONE
#define WR3150_SET_LEVEL (RIG_LEVEL_ATT | RIG_LEVEL_AF)
#define WR3150_LEVEL (WR3150_SET_LEVEL | RIG_LEVEL_STRENGTH)
...
const struct rig_caps wr3150_caps = {
  ...
  .has_get_func =   WR3150_FUNC,
  .has_set_func =   WR3150_FUNC,
  .has_get_level =  WR3150_LEVEL,
  .has_set_level =  WR3150_SET_LEVEL,
