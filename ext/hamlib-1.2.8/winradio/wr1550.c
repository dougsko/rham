...
#define WR1550_FUNC  RIG_FUNC_NONE
#define WR1550_SET_LEVEL (RIG_LEVEL_ATT | RIG_LEVEL_AF)
#define WR1550_LEVEL (WR1550_SET_LEVEL | RIG_LEVEL_STRENGTH)

#define WR1550_MODES (RIG_MODE_AM | RIG_MODE_CW | \
                     RIG_MODE_USB | RIG_MODE_LSB | RIG_MODE_FM)

const struct rig_caps wr1550_caps = {
  .rig_model =      RIG_MODEL_WR1550,
  .model_name =     "WR-1550",
  .mfg_name =       "Winradio",
  .version =        "0.6",
  .copyright = 	 "LGPL",
  ...
  .has_set_func =   WR1550_FUNC,
  .has_get_level =  WR1550_LEVEL,
  .has_set_level =  WR1550_SET_LEVEL,
