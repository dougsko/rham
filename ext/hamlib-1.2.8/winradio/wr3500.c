...
#define WR3500_FUNC  RIG_FUNC_FAGC
#define WR3500_SET_LEVEL (RIG_LEVEL_ATT | RIG_LEVEL_AF | RIG_LEVEL_IF | RIG_LEVEL_RF)
#define WR3500_LEVEL (WR3500_SET_LEVEL | RIG_LEVEL_STRENGTH)

#define WR3500_MODES (RIG_MODE_AM | RIG_MODE_CW | \
                     RIG_MODE_USB | RIG_MODE_LSB | RIG_MODE_FM)

const struct rig_caps wr3500_caps = {
  ...
  .has_get_func =   WR3500_FUNC,
  .has_set_func =   WR3500_FUNC,
  .has_get_level =  WR3500_LEVEL,
  .has_set_level =  WR3500_SET_LEVEL,
